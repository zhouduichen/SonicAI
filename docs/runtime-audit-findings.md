...
- 2026-05-29: **P2 Entry point split** — Added entry point comparison table to README clarifying `start_all.py` (full product) vs `main.py` (lightweight framework, no Web UI) vs `backend/app/main.py` (API only).
